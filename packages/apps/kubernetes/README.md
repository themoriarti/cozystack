...
| `proxmox.insecure`                            | Skip verification of the Proxmox API server certificate in the CCM and the CSI driver. Default true because a stock Proxmox VE install serves a self-signed certificate; set false once the hypervisor presents one the tenant can verify.                                                                                                                                                                                                                                                                                                     | `bool`     | `true`     |

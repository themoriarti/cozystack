...
| `computeplane`    | Deploy own ComputePlane — a single-tenant, Cozystack-managed cluster for untrusted-code applications. Applications with placement: ComputePlane are routed onto it. The tenant receives no admin kubeconfig for it. See design-proposals/compute-plane in cozystack/community.                                                                                                                                                                                                                                                               | `bool`                | `false` |
